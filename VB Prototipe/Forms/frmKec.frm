...
Begin VB.Form frmKecamatan 
   ...
   Begin TabDlg.SSTab sstData 
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   3
         Left            =   3960
         MouseIcon       =   "frmKec.frx":0038
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":018A
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Search"
         Top             =   4320
   ...
   Begin VB.Frame frmButton 
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   9
         Left            =   1920
         MouseIcon       =   "frmKec.frx":0793
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":08E5
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   8
         Left            =   1560
         MouseIcon       =   "frmKec.frx":0B37
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":0C89
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   7
         Left            =   480
         MouseIcon       =   "frmKec.frx":0E95
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":0FE7
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   6
         Left            =   120
         MouseIcon       =   "frmKec.frx":11F6
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":1348
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   5
         Left            =   120
         MouseIcon       =   "frmKec.frx":1597
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":16E9
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   10
         Left            =   1200
         MouseIcon       =   "frmKec.frx":1C81
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":1DD3
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Cancel"
         Top             =   2040
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   2
         Left            =   120
         MouseIcon       =   "frmKec.frx":2353
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":24A5
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   4680
         Width           =   2175
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   4
         Left            =   120
         MouseIcon       =   "frmKec.frx":2A1F
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":2B71
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   1
         Left            =   120
         MouseIcon       =   "frmKec.frx":30BB
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":320D
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Left            =   120
         MaskColor       =   &H8000000F&
         MouseIcon       =   "frmKec.frx":37B2
         MousePointer    =   99  'Custom
         Picture         =   "frmKec.frx":3904
         Style           =   1  'Graphical
         TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmKecamatan"
...
Private Sub Form_Load()
 ...
 strSQL = "select kode,nama from tbKec Order by kode"
...
Private Sub pHapus()
  If MsgBox("Anda Yakin Record Ini Dihapus ?", vbYesNo + vbQuestion, "DINKES - SP2TP") = vbYes Then
   strSQL = "DELETE FROM tbKec WHERE kode='" & Trim(txtData(1).Text) & "'"
...
'saving new record
 If saveFlag = True Then
  strSQL = "INSERT INTO tbKec(kode,nama) " & _
     "VALUES('" & Trim(txtData(1).Text) & _
     "','" & Trim(txtData(2).Text) & "')"
 Else 'for editing the record
  strSQL = "UPDATE tbKec SET " & _
