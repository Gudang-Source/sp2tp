...
Begin VB.Form frmJenisPenyakit 
   BackColor       =   &H00FF8080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Data Jenis Penyakit"
   ClientHeight    =   5715
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7650
   ...
   Begin TabDlg.SSTab sstData 
      ...
      TabPicture(0)   =   "frmJnsPny.frx":0000
      ...
      TabPicture(1)   =   "frmJnsPny.frx":001C
      ...
      Tab(1).Control(5)=   "txtdata(2)"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "txtdata(3)"
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   3
         Left            =   3960
         MouseIcon       =   "frmJnsPny.frx":0038
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":018A
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Search"
         Top             =   4320
   ...
   Begin VB.Frame frmButton 
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   9
         Left            =   1920
         MouseIcon       =   "frmJnsPny.frx":0793
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":08E5
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   8
         Left            =   1560
         MouseIcon       =   "frmJnsPny.frx":0B37
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":0C89
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   7
         Left            =   480
         MouseIcon       =   "frmJnsPny.frx":0E95
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":0FE7
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   6
         Left            =   120
         MouseIcon       =   "frmJnsPny.frx":11F6
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":1348
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   5
         Left            =   120
         MouseIcon       =   "frmJnsPny.frx":1597
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":16E9
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   10
         Left            =   1200
         MouseIcon       =   "frmJnsPny.frx":1C81
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":1DD3
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Cancel"
         Top             =   2040
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   2
         Left            =   120
         MouseIcon       =   "frmJnsPny.frx":2353
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":24A5
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   4680
         Width           =   2175
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   4
         Left            =   120
         MouseIcon       =   "frmJnsPny.frx":2A1F
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":2B71
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   1
         Left            =   120
         MouseIcon       =   "frmJnsPny.frx":30BB
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":320D
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Left            =   120
         MaskColor       =   &H8000000F&
         MouseIcon       =   "frmJnsPny.frx":37B2
         MousePointer    =   99  'Custom
         Picture         =   "frmJnsPny.frx":3904
         Style           =   1  'Graphical
         TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmJenisPenyakit"
...
Private Sub cmdButton_Click(Index As Integer)
 ...
 Case 0     'Tambah Data
  ...
  Set extRec = adoCon.Execute("select kode from tbJenisPenyakit " & _
             "where kode LIKE 'JPE-%' order by kode desc")
  If extRec.EOF Then
   txtdata(1).Text = "JPE-000001"
  Else
   noKode = Str(val(Right(extRec.Fields(0), 6)) + 1)
   For count = 1 To (7 - Len(noKode))
    noKode = "0" + Trim(noKode)
   Next
   txtdata(1).Text = Trim("JPE-" + noKode)
  End If
  Set extRec = Nothing
...
Private Sub Form_Load()
 ...
 strSQL = "select kode,nama,kdTampil from tbJenisPenyakit Order by kode"
...
Private Sub pHapus()
  If MsgBox("Anda Yakin Record Ini Dihapus ?", vbYesNo + vbQuestion, "DINKES - SP2TP") = vbYes Then
   strSQL = "DELETE FROM tbJenisPenyakit WHERE kode='" & Trim(txtdata(1).Text) & "'"
...
'saving new record
 If saveFlag = True Then
  strSQL = "INSERT INTO tbJenisPenyakit(kode,nama,kdTampil) " & _
     "VALUES('" & Trim(txtdata(1).Text) & _
     "','" & Trim(txtdata(2).Text) & _
     "','" & Trim(txtdata(3).Text) & "')"
 Else 'for editing the record
  strSQL = "UPDATE tbJenisPenyakit SET " & _
...
Private Sub Grid_Resize()
  ...
  DataGrid.Columns(1).Caption = "JENIS PENYAKIT"
  DataGrid.Columns(2).Caption = "KODE"
  DataGrid.Columns(2).Alignment = dbgCenter

  DataGrid.Columns(1).Width = 3500
  DataGrid.Columns(2).Width = 700
End Sub
