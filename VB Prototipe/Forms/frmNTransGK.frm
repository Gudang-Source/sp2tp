...
Begin VB.Form frmNTransGK 
   ...
   Begin VB.ComboBox cmbData 
      ...
      Height          =   420
      Index           =   1
      ItemData        =   "frmNTransGK.frx":0000
      Left            =   120
      List            =   "frmNTransGK.frx":0002
   ...
   Begin VB.ListBox lstData 
      ...
      EndProperty
      Height          =   2130
      ItemData        =   "frmNTransGK.frx":0004
      Left            =   120
      List            =   "frmNTransGK.frx":0006
      TabIndex        =   7
      Top             =   3840
      Width           =   9975
   End
   Begin vbComCtl.ucFrame ucFrame1 
      ...
      Begin VB.ComboBox cmbData 
         ...
         Height          =   480
         Index           =   0
         ItemData        =   "frmNTransGK.frx":0008
         Left            =   1800
         List            =   "frmNTransGK.frx":0030
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   360
         Width           =   1935
...
Private Sub cmdBtn_Click(Index As Integer)
 ...
 Case 0
  con.Execute "delete from tbTransGK " & _
     "where kdPuskesmas=''"
  con.Execute "delete from tbTransDtlGK " & _
     "where kdSubKegiatan=''"
  'Ask = vbNo
  'Call newBtn_Click
  Unload Me
...
Private Sub Seleksi_Proses()
 ...
 Ask = MsgBox("Data LB3 Baru ?", vbYesNoCancel + vbQuestion + vbDefaultButton1, "DINAS KESEHATAN")
