...
Begin VB.Form rptLB1 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbData 
         Height          =   315
         Index           =   2
         ItemData        =   "rptLB1.frx":0000
         Left            =   1320
         List            =   "rptLB1.frx":0002
      ...
      Begin VB.ComboBox cmbData 
         Height          =   315
         Index           =   1
         ItemData        =   "rptLB1.frx":0004
         Left            =   1320
         List            =   "rptLB1.frx":0006
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   720
         Width           =   1575
      ...
      Begin VB.ComboBox cmbData 
         Height          =   315
         Index           =   0
         ItemData        =   "rptLB1.frx":0008
         Left            =   840
         List            =   "rptLB1.frx":0030
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   240
         Width           =   1575
