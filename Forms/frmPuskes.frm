...
Begin VB.Form frmPuskesmas 
   ...
   Begin TabDlg.SSTab sstData 
      ...
      Tab(1).Control(12)=   "txtdata(2)"
      Tab(1).Control(13)=   "txtdata(3)"
      Tab(1).Control(14)=   "txtdata(4)"
      Tab(1).Control(15)=   "txtdata(5)"
      Tab(1).Control(16)=   "txtdata(6)"
      Tab(1).Control(17)=   "txtdata(7)"
      Tab(1).Control(18)=   "txtdata(8)"
      Tab(1).Control(19)=   "txtdata(9)"
      Tab(1).Control(20)=   "txtdata(10)"
      Tab(1).Control(21)=   "txtdata(11)"
      Tab(1).Control(22)=   "txtdata(12)"
