...
Begin VB.Form frmTransKegiatan 
   BackColor       =   &H00C00000&
   BorderStyle     =   0  'None
   ...
   Begin VB.ComboBox cmbData 
      ...
      Height          =   315
      Index           =   1
      ItemData        =   "frmTransKegiatan.frx":0000
      Left            =   120
      List            =   "frmTransKegiatan.frx":0002
   ...
   Begin VB.ListBox lstData 
      ...
      Enabled         =   0   'False
      Height          =   1200
      ItemData        =   "frmTransKegiatan.frx":0004
      Left            =   120
      List            =   "frmTransKegiatan.frx":0006
      TabIndex        =   7
      Top             =   2520
      Width           =   3015
   End
   Begin vbComCtl.ucFrame ucFrame1 
      ...
      Begin VB.ComboBox cmbData 
         ...
         Height          =   315
         Index           =   0
         ItemData        =   "frmTransKegiatan.frx":0008
         Left            =   1800
         List            =   "frmTransKegiatan.frx":0030
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   360
         Width           =   1575
   ...
   End
End
Attribute VB_Name = "frmTransKegiatan"
...
Private Sub cmbData_LostFocus(Index As Integer)
 ...
 Case 0
  If Trim(cmbData(0).Text) <> vbNullString And _
   ...
   Ask = MsgBox("Data LB4 Baru ?", vbYesNoCancel + vbQuestion + vbDefaultButton1, "DINKES")
   If Ask = vbYes Then
    tEdit = False
    clearForm
    con.BeginTrans
...
'  Set rsFind = Nothing
  ...
  Set rsFind = con.Execute("select jumlahL,jumlahP,total from qTransKegiatan " & _
