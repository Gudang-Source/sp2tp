...
Begin VB.Form frmPenyakit 
   ...
   Begin TabDlg.SSTab sstData 
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   3
         Left            =   4920
         MouseIcon       =   "frmPeny.frx":0038
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":018A
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Search"
         Top             =   4320
   ...
   Begin VB.Frame frmButton 
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   9
         Left            =   1920
         MouseIcon       =   "frmPeny.frx":0793
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":08E5
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   8
         Left            =   1560
         MouseIcon       =   "frmPeny.frx":0B37
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":0C89
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   7
         Left            =   480
         MouseIcon       =   "frmPeny.frx":0E95
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":0FE7
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   6
         Left            =   120
         MouseIcon       =   "frmPeny.frx":11F6
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":1348
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   5
         Left            =   120
         MouseIcon       =   "frmPeny.frx":1597
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":16E9
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   10
         Left            =   1200
         MouseIcon       =   "frmPeny.frx":1C81
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":1DD3
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Cancel"
         Top             =   2040
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   2
         Left            =   120
         MouseIcon       =   "frmPeny.frx":2353
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":24A5
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   4680
         Width           =   2175
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   4
         Left            =   120
         MouseIcon       =   "frmPeny.frx":2A1F
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":2B71
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   1
         Left            =   120
         MouseIcon       =   "frmPeny.frx":30BB
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":320D
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Left            =   120
         MaskColor       =   &H8000000F&
         MouseIcon       =   "frmPeny.frx":37B2
         MousePointer    =   99  'Custom
         Picture         =   "frmPeny.frx":3904
         Style           =   1  'Graphical
         TabIndex        =   0
...
Private Sub cmdButton_Click(Index As Integer)
 ...
 Case 0     'Tambah Data
  ...
  Set extRec = adoCon.Execute("select kode from tbPenyakit " & _
             "where kode LIKE 'DPE-%' order by kode desc")
  If extRec.EOF Then
   txtdata(1).Text = "DPE-000001"
  Else
   noKode = Str(val(Right(extRec.Fields(0), 6)) + 1)
   For count = 1 To (7 - Len(noKode))
    noKode = "0" + Trim(noKode)
   Next
   txtdata(1).Text = Trim("DPE-" + noKode)
  End If
  Set extRec = Nothing
...
Private Sub Form_Load()
 ...
 strSQL = "select * from tbPenyakit Order by kode"
...
Private Sub Scatter()
 ...
 If adoRec.EOF = False And adoRec.BOF = False Then
  ...
  strSQL = "select nama from tbJenisPenyakit where kode='" & _
           adoRec.Fields(2) & "'"
...
Private Sub pHapus()
  If MsgBox("Anda Yakin Record Ini Dihapus ?", vbYesNo + vbQuestion, "DINKES - SP2TP") = vbYes Then
   strSQL = "DELETE FROM tbPenyakit WHERE kode='" & Trim(txtdata(1).Text) & "'"
...
Private Sub txtdata_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
 If KeyCode = 13 And Editing Then
  ...
  Case 3    'Jenis Penyakit
   strSQL = "select * from tbJenisPenyakit"
...
Private Sub Grid_Resize()
  ...
  DataGrid.Columns(1).Caption = "DAFTAR PENYAKIT"
  DataGrid.Columns(3).Caption = "KODE"
  DataGrid.Columns(3).Alignment = dbgCenter

  DataGrid.Columns(1).Width = 4300
  DataGrid.Columns(3).Width = 800
End Sub
