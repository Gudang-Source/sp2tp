...
Begin VB.Form frmKegBulanan 
   BackColor       =   &H00FF8080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Kegiatan Puskesmas"
   ClientHeight    =   5715
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8610
   ...
   Begin TabDlg.SSTab sstData 
      ...
      TabPicture(0)   =   "frmKegBul.frx":0000
      ...
      TabPicture(1)   =   "frmKegBul.frx":001C
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   3
         Left            =   4920
         MouseIcon       =   "frmKegBul.frx":0038
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":018A
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Search"
         Top             =   4320
   ...
   Begin VB.Frame frmButton 
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   9
         Left            =   1920
         MouseIcon       =   "frmKegBul.frx":0793
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":08E5
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   8
         Left            =   1560
         MouseIcon       =   "frmKegBul.frx":0B37
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":0C89
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   7
         Left            =   480
         MouseIcon       =   "frmKegBul.frx":0E95
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":0FE7
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   6
         Left            =   120
         MouseIcon       =   "frmKegBul.frx":11F6
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":1348
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   5
         Left            =   120
         MouseIcon       =   "frmKegBul.frx":1597
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":16E9
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   10
         Left            =   1200
         MouseIcon       =   "frmKegBul.frx":1C81
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":1DD3
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Cancel"
         Top             =   2040
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   2
         Left            =   120
         MouseIcon       =   "frmKegBul.frx":2353
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":24A5
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   4680
         Width           =   2175
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   4
         Left            =   120
         MouseIcon       =   "frmKegBul.frx":2A1F
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":2B71
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Index           =   1
         Left            =   120
         MouseIcon       =   "frmKegBul.frx":30BB
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":320D
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      Begin VB.CommandButton cmdButton 
         ...
         Left            =   120
         MaskColor       =   &H8000000F&
         MouseIcon       =   "frmKegBul.frx":37B2
         MousePointer    =   99  'Custom
         Picture         =   "frmKegBul.frx":3904
         Style           =   1  'Graphical
         TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmKegBulanan"
...
Private Sub cmdButton_Click(Index As Integer)
 ...
 Case 0     'Tambah Data
  ...
  Set extRec = adoCon.Execute("select kode from tbSubKegiatan " & _
          "where kode LIKE 'KPS-%' order by kode desc")
  If extRec.EOF Then
   txtdata(1).Text = "KPS-000001"
  Else
   noKode = Str(val(Right(extRec.Fields(0), 6)) + 1)
   For count = 1 To (7 - Len(noKode))
    noKode = "0" + Trim(noKode)
   Next
   txtdata(1).Text = Trim("KPS-" + noKode)
  End If
  Set extRec = Nothing
...
Private Sub Form_Load()
 ...
 strSQL = "select * from tbSubKegiatan Order by kode"
...
Private Sub pHapus()
  If MsgBox("Anda Yakin Record Ini Dihapus ?", vbYesNo + vbQuestion, "DINKES - SP2TP") = vbYes Then
   strSQL = "DELETE FROM tbSubKegiatan WHERE kode='" & Trim(txtdata(1).Text) & "'"
...
Private Sub Grid_Resize()
  ...
  DataGrid.Columns(1).Caption = "KEGIATAN PUSKESMAS"
